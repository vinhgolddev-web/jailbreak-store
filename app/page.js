  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden py-20 lg:py-0">
        ...
        <div className="container relative z-10 text-center space-y-6 sm:space-y-8 max-w-4xl px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8 }}
          >
            <span className="inline-block py-1 px-3 rounded-full bg-white/5 border border-white/10 text-primary text-xs sm:text-sm font-bold tracking-widest mb-4 sm:mb-6">
              EST. 2026 • THỊ TRƯỜNG CAO CẤP
            </span>
            <h1 className="text-4xl sm:text-6xl lg:text-8xl font-display font-black tracking-tighter leading-tight mb-4 sm:mb-6">
              THỐNG TRỊ <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-primaryGlow to-accent animate-gradient-x">
                JAILBREAK
              </span>
            </h1>
            <p className="text-base sm:text-xl text-gray-400 max-w-xl sm:max-w-2xl mx-auto leading-relaxed">
          ...
          >
            <Link href="/shop" className="w-full sm:w-auto">
              <Button className="w-full sm:w-auto sm:px-12 text-base sm:text-lg py-4 sm:py-3">
                Bắt Đầu <ArrowRight size={20} className="ml-2" />
              </Button>
            </Link>
            <Link href="/register" className="w-full sm:w-auto">
              <Button variant="secondary" className="w-full sm:w-auto sm:px-12 text-base sm:text-lg py-4 sm:py-3">
                Đăng Ký
              </Button>
            </Link>
          </motion.div>
      ...
      {/* Trust Indicators */}
      <section className="py-12 sm:py-20 bg-surface/30 border-y border-white/5 backdrop-blur-sm">

...
import { LayoutDashboard, Users, ShoppingBag, Package, LogOut, ArrowLeft, Search } from 'lucide-react';
        ...
        <div className="min-h-screen flex bg-background">
            ...
            <div className="w-64 bg-surfaceHighlight border-r border-white/10 flex flex-col fixed h-full z-40">
                ...
                <div className="p-4 border-t border-white/10 space-y-2">
                    ...
                    <Link href="/admin/lookup" className="flex items-center gap-3 px-4 py-3 text-gray-400 hover:text-white hover:bg-white/5 rounded-xl transition-colors">
                        <Search size={20} /> Lookup Tool
                    </Link>
                    <button
                        onClick={logout}
